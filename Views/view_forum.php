...
<body>
        ...
        <div class="inner-sidebar-header justify-content-center">
            <button class="btn btn-primary has-icon btn-block" type="button" data-toggle="modal" onclick='window.location.href = "?controller=accueil&action=ajout_page";'>
        ...
        <div class="inner-sidebar-header justify-content-center">
            <button class="btn btn-primary has-icon btn-block" type="button" data-toggle="modal" data-target="#threadModal" onclick='window.location.href = "?controller=deconnexion";'>
                DECONNEXION
            </button>
        </div>
            ...
            <div class="simplebar-wrapper" style="margin: -16px;">
                <div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div>
                    <div class="simplebar-mask">
                        ...
                        <div class="simplebar-placeholder" style="width: 200px; height: 20px;"></div>
                    </div>
                        <div class="simplebar-track simplebar-horizontal" style="visibility: hidden;"><div class="simplebar-scrollbar" style="width: 0px; display: none;"></div></div>
                        <div class="simplebar-track simplebar-vertical" style="visibility: visible;"><div class="simplebar-scrollbar" style="height: 0px; display: block; transform: translate3d(0px, 0px, 0px);"></div></div>
                </div>
            </div>
        </div> -->
        ...
        <div class="inner-main-header">
            ...
            <form action="?controller=accueil">
                <span class="input-icon input-icon-sm ml-auto w-auto">
                    <input type="text" name="controller" value="accueil" hidden>
                    <input name="search" type="text" class="form-control form-control-sm bg-gray-200 border-gray-200 shadow-none mb-4 mt-4" placeholder="Search forum" />
        ...
        <?php $i = 0; ?>
        <?php foreach ($data['liste'] as $key => $value): ?>
            <?php $i += 1; ?>
            <div class="card mb-2">
                <div class="card-body p-2 p-sm-3">
                    <div class="media forum-item">
                        ...
                        <div class="text-muted small text-center align-self-center">
                            <span class="d-none d-sm-inline-block"><i class="far fa-eye"></i> <?php echo '1'; ?></span>
                            <span><i class="far fa-comment ml-2"></i> <?php echo "1"; ?></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- <div class="card mb-2">
            <div class="card-body p-2 p-sm-3">
                    ...
                    <div class="media-body">
                        ...
                        <p class="text-secondary">lorem ipsum dolor sit amet lorem ipsum dolor sit amet lorem ipsum dolor sit amet</p>
        ...
        <div class="media forum-item">
            ...
            <div class="mt-3 font-size-sm">
                <p>Hellooo :)</p>
                <p>I'm newbie with laravel and i want to fetch data from database in realtime for my dashboard anaytics and i found a solution with ajax but it dosen't work if any one have a simple solution it will be
                helpful</p>
                <p>Thank</p>
            </div>
        </div>
